...
void GameState::Draw() {
    ...
    for (const auto& s : settlements) {
        ...
        if (s.pop == 0) {
            ...
            bool coldSeason = (s.seasonName == "Autumn" || s.seasonName == "Winter");
...
Color GameState::SkyColor() const {
    ...
    std::string seasonNameLocal;
    {
        ...
        seasonNameLocal = m_snapshot.seasonName;
    }
